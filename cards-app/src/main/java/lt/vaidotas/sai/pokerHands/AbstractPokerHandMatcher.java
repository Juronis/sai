...
public abstract class AbstractPokerHandMatcher {
    ...
    /**
     * @return name of hand, like "High Card" or "Royal Flush"
     */
    ...
    public HandMatchInfo matchesAndGetHandCards(Card[] cards){
        ...
        if(stongerHandMatchInfo.getCardsInHand() != null){
     ...
     * @return pair of same-rank cards if there are any among given cards
     */
